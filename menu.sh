...
install_falcon_proxy() {
    ...
    local releases_json=$(curl -s "https://api.github.com/repos/noelrubio143/hotscript/releases")
    ...
    local download_url="https://github.com/noelrubio143/hotscript/releases/download/$SELECTED_VERSION/$binary_name"
