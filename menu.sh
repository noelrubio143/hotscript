...
DNSTT_V2_USER="dnstt"
# --- slipstream-rust-deploy (DNS tunnel, uses the same port 53/5300 pattern as dnstt-deploy) ---
...
main() {
    ...
    # NOTE: dnstt check removed - slipstream-rust and dnstt can be installed side by side
    # (public port 53 collisions are handled by the DNS demux, not by blocking installs).
